...
import EmployeeVisitManagement from "../components/dealers/EmployeeVisitManagement"
...
function VisitReport() {
  ...
  const renderContent = () => {
    if (currentPath.includes("/visit")) {
      return <EmployeeVisitManagement />
    } 
    return <EmployeeVisitManagement /> // Default fallback
  }
