  ...
  const fetchExistingTasks = async () => {
    ...
    try {
      const response = await fetch(
        `https://namami-infotech.com/NIKHILOFFSET/src/task/project_task.php?TenderNo=${tenderNo}`,
      )
...
const filterAvailableStations = () => {
  ...
  useEffect(() => {
    // Fetch stations
    fetch(`https://namami-infotech.com/NIKHILOFFSET/src/tender/tender_stations.php?ActivityId=${ActivityId}`)
      .then((res) => res.json())
      .then((data) => {
    ...
    // Fetch technicians
    fetch("https://namami-infotech.com/NIKHILOFFSET/src/employee/list_employee.php?Tenent_Id=1")
  .then((res) => res.json())
  .then((data) => {
    if (data.success) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      for (const station of selectedStations) {
        ...
        try {
          const response = await fetch("https://namami-infotech.com/NIKHILOFFSET/src/task/add_task.php", {
            method: "POST",
            headers: {
          ...
          <CardHeader
            ...
            title={
              <Typography
                ...
                component="div"
                sx={{
                  background: "linear-gradient(45deg, #344C7D, #344C7D)",
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  <Typography variant="h6" gutterBottom sx={{ fontWeight: 600, color: "#344C7D" }}>
                    Select Milestone
                  </Typography>
                  <Autocomplete
                    ...
                    >
                      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        <Avatar
                          ...
                          sx={{ width: 48, height: 48, border: "2px solid #344C7D" }}
                        >
                    ...
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField
                          ...
                          InputProps={{
                            ...params.InputProps,
                            startAdornment: <CalendarToday sx={{ color: "#344C7D", mr: 1 }} />,
                          }}
                        />
                      )}
                    />
              ...
              {/* {milestone && selectedStations.length > 0 && technician && date && (
                ...
                >
                  <Typography variant="h6" textAlign="center" gutterBottom sx={{ color: "#344C7D", fontWeight: 600 }}>
