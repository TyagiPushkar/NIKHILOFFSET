...
function EmployeeList() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const url =
      formMode === "add"
        ? "https://namami-infotech.com/NIKHILOFFSET/src/employee/add_employee.php"
        : "https://namami-infotech.com/NIKHILOFFSET/src/employee/edit_employee.php"
  ...
  const handleToggleEmployeeStatus = async (employee) => {
    ...
    try {
      ...
      const response = await fetch("https://namami-infotech.com/NIKHILOFFSET/src/employee/disable_employee.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    <div style={{ padding: "20px" }}>
      ...
      <Grid container spacing={2} alignItems="center" style={{ marginBottom: "20px" }}>
        ...
        <Grid item xs={12} md={4} style={{ textAlign: "right" }}>
          <Button
            variant="contained"
            style={{ backgroundColor: "#344C7D", color: "white" }}
            startIcon={<AddIcon />}
