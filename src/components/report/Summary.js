    ...
    const fetchData = async () => {
      try {
        ...
        const transactionsResponse = await axios.get(
          "https://namami-infotech.com/NIKHILOFFSET/src/menu/get_transaction.php?menuId=8"
        );
        
        // Fetch status data (menuId=10)
        const statusResponse = await axios.get(
          "https://namami-infotech.com/NIKHILOFFSET/src/menu/get_transaction.php?menuId=10"
        );
