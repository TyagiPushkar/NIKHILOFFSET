...
const CreateTicketDialog = ({ open, onClose, onTicketCreated }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [techResponse, stationResponse] = await Promise.all([
        ...
        fetch("https://namami-infotech.com/NIKHILOFFSET/src/buyer/buyer_list.php")
      ])
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("https://namami-infotech.com/NIKHILOFFSET/src/support/create_ticket.php", {
        method: "POST",
        body: formDataToSend,
      })
