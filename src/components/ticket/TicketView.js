...
const TicketView = () => {
  ...
  useEffect(() => {
    const fetchTicketDetails = async () => {
      try {
        ...
        const response = await fetch(
          `https://namami-infotech.com/NIKHILOFFSET/src/task/get_task_detail.php?taskId=${ticketId}`,
        )
    ...
    const fetchMenus = async () => {
      try {
        const response = await fetch("https://namami-infotech.com/NIKHILOFFSET/src/menu/get_menu.php")
        const data = await response.json()
    ...
    const fetchCheckpoints = async () => {
      try {
        const response = await fetch("https://namami-infotech.com/NIKHILOFFSET/src/menu/get_checkpoints.php")
        const data = await response.json()
        ...
        <CardContent>
          <Box sx={{ mb: 3 }}>
            <Typography variant="h6" sx={{ mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
              <Description color="primary" /> Ticket Fields
            </Typography>
