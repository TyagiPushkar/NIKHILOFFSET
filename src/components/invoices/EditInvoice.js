...
function EditInvoice() {
    ...
    try {
      ...
      if (fileEntries.length > 0) {
        ...
        const imageResponse = await axios.post(
          ...
          {
            menuId: 9, // Assuming menuId is 9 for Invoices
            ActivityId: transaction.ActivityId,
            LatLong: null,
            data: imageData
          }
      ...
      setTimeout(() => navigate("/invoices-list"), 1500);
    } catch (err) {
  ...
  const isDocumentField = (checkpointId) => {
    return ["583", "588"].includes(checkpointId.toString());
  };
  ...
  return (
    <div className="material-list-container">
      <div className="material-list-header">
        <h2 className="material-list-title">Edit Invoice</h2>
