...
useEffect(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true)
      try {
        const menuRes = await axios.get("https://namami-infotech.com/NIKHILOFFSET/src/menu/get_menu.php")
        const checkpointRes = await axios.get("https://namami-infotech.com/NIKHILOFFSET/src/menu/get_checkpoints.php")
        const typeRes = await axios.get("https://namami-infotech.com/NIKHILOFFSET/src/menu/get_types.php")
        ...
        if (ActivityId) {
          const transRes = await axios.get(
            `https://namami-infotech.com/NIKHILOFFSET/src/menu/get_transaction_dtl.php?activityId=${ActivityId}`,
          )
      ...
      (pos) => {
        ...
        const submitData = async () => {
          ...
          try {
            ...
            await axios.post("https://namami-infotech.com/NIKHILOFFSET/src/menu/update_transaction.php", {
              menuId,
              ActivityId,
              LatLong: latLong,
              Draft: isDraft ? 1 : 0,
            ...
            if (Object.keys(imageData).length > 0) {
              ...
              await axios.post("https://namami-infotech.com/NIKHILOFFSET/src/menu/add_image.php", {
                menuId,
                ActivityId,
                LatLong: latLong,
                data: imageData,
    ...
    return (
      <Box display="flex" justifyContent="center" alignItems="center" height="80vh">
        <Box sx={{ maxWidth: 500, textAlign: "center", p: 3, bgcolor: "#ffebee", borderRadius: 1 }}>
          ...
          <Button
            sx={{ mt: 2, color: "#344C7D", borderColor: "#344C7D" }}
