      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route
              path="/job-card-list"
              element={<PrivateRoute element={Tender} />}
            />
            ...
            <Route
              ...
              element={<PrivateRoute element={ViewTender} />}
            />
            <Route
              path="/loa/view/:activityId"
              element={<PrivateRoute element={ViewLOA} />}
            />

            <Route
              path="/visit"
              element={<PrivateRoute element={VisitReport} />}
            />
            <Route path="/tasks" element={<PrivateRoute element={Task} />} />

            <Route
              path="/ot-report"
              element={<PrivateRoute element={OTReport} />}
            />

            <Route
              path="/consignee"
              element={<PrivateRoute element={Buyer} />}
            />
            <Route
              path="/new-consignee"
              element={<PrivateRoute element={Buyer} />}
            ...
            <Route
              path="/amc-work"
              element={<PrivateRoute element={AMCWork} />}
            />
            <Route
              path="/add-amc-work"
              element={<PrivateRoute element={AMCWork} />}
            ...
            <Route
              path="/checkpoints"
              element={<PrivateRoute element={Checkpoints} />}
            />
            <Route
              path="/add-checkpoint"
              element={<PrivateRoute element={Checkpoints} />}
